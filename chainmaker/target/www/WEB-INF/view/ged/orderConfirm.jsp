...
<script src="${CTX_PATH}/js/view/ged/orderConfirm/orderConfirm.js"></script>
					...
					<div class="content">
						...
						<p class="Location">
							<a href="/dashboard/dashboard.do" class="btn_set home">메인으로</a> <a href="#"
								class="btn_nav">승인</a> <span class="btn_nav bold">구매 승인</span> <a href="../ged/orderConfirm.do" class="btn_set refresh">새로고침</a>
						</p>
