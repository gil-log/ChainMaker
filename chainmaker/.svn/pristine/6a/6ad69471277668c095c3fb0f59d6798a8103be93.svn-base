...
<script type="text/javascript">
	...
	function flistInquiryResult(data, currentPage) {
		...
		console.log("totalCntlistInquiry : " + totalCntlistInquiry);	
		console.log("currentPage : " + currentPage);	
		console.log("pageSizeinquiry : " + pageSizeinquiry);	
		console.log("pageBlockSizeinquiry : " + pageBlockSizeinquiry);	
			...
			<ul>
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="conTitle">
							<span>1:1문의</span> <span class="fr"> <a
							...
							<table class="col">
								...
								<thead>
									<tr>
										...
										<th scope="col">작성자</th>
										<th scope="col">답글코드</th>
										<th scope="col">수정</th>
									</tr>
								</thead>
								<tbody id="listInquiry"></tbody>
							</table>
						</div>
