					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3" style='width:30%'>
								<input type="text"  style="width:100px;" name="email" id="email" >
								@								
								<select style="width:100px; height:15.6px;" id="email_cop" name="email_cop" >
						...
						<tr>
							...
							<th scope="row">연락처</th>
							<td colspan="3"><select style="width: 50px; height: 15.6px;" id="tel1" name="tel1">
									<option>선택하세요</option>
