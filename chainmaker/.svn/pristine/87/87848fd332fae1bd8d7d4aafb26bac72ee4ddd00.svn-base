...
<form id="myForm" action=""  method="">
	...
	<!-- 모달팝업 -->
	<div id="deliDirection" class="layerPop layerType2" style="width: 900px;">
		<dl>
			<dt>
			...
			<dd class="content">
				<!-- s : 여기에 내용입력 -->
								...
								<tbody>
									...
									<tr>
										<td>
											<a type="text" class="inputTxt p100" name="order_no" id="order_no" readonly="readonly"/></a>
										</td>
										<td id="order_date"></td>
				...
				<table class="row">
					...
					<tbody>
						<tr>
							...
							<select style="width:160px" id="ware_name_option" name="ware_name_option" onchange="fSelectedOptions(this.options[this.selectedIndex].value, ware_name_option)">
							</select>
							
							</td>
								
							<th scope="row">재고 개수 <span class="font_red"></span></th>
							<td><input type="text" class="inputTxt p100" name="grp_cod_nm" id="grp_cod_nm" readonly="readonly"/></td>
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType gray" id="btnSaveGrpCod" name="btn"><span>완료</span></a> 
					<a href="" class="btnType blue" id="btnSaveGrpCod" name="btn"><span>추가</span></a> 
