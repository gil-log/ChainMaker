...
public class ProductInfoModel {
	...
	public ProductInfoModel(String pro_model_no, String pro_no, String pro_name, String deli_company, int pro_deli_price,
			String pro_model_name, String pro_manu_name, int pro_price, String pro_detail, String pro_cd) {
		super();
		this.pro_model_no = pro_model_no;
		this.pro_no = pro_no;
	...
	public String getPro_model_no() {
		return pro_model_no;
	}


	public void setPro_model_no(String pro_model_no) {
		this.pro_model_no = pro_model_no;
	}
