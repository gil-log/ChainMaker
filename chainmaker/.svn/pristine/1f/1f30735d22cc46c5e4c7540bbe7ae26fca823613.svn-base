...
<script type="text/javascript">
	...
	function fButtonClickEvent(){
		$('a[name=btn]').click(function(e){
			...
			switch(btnId){
			case 'btnSavePro' : fSaveUser(); // save 안에 저장,수정
				//alert("저장버튼 클릭!!!이벤트!!");
				break;
			case 'btnDeletePro' : fDeleteUser();	// 만들자 
				//alert("삭제버튼 클릭!!!이벤트!!");		
				break;
	...
	function fOnloadImg(param){
	 ...
	 function fUserModal(pro_no) {
		 ...
		 if(pro_no == null || pro_no==""){
			...
			// Tranjection type 설정
			$("#action").val("U");  // update
			fdetailModal(pro_no); //번호로 -> 공지사항 상세 조회 팝업 띄우기
		 }
				...
				<table class="row" >
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
							<textarea style="height:130px;outline:none;resize:none;" placeholder="여기에 상세정보를 적어주세요."></textarea>
							</td>
		                    ...
		                    <td class="thumb">
								...
								<input name="thumbF" type="file" id="getfile" accept="image/* " required>
								 ...
								 <td colspan="2" style="text-align:center;">
								 	<img id="thumbnail" style="object-fit: cover;" src="../img/noImg.jpg" alt="썸네일영역">
								 </td>
                	</tr>		
